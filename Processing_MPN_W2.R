...
write_sav(Diary_purposerec, "/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2014/DAGBOEK data 2014 English_cleaned.sav")
...
write.csv(Mode_use, "/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2014/MPN data 2014_ModeUse.csv")
...
#Read data
Preference <- read_sav("/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2014/P data 2014 English.sav")

#-----------------------------------------------Commute------------------------------------------------------------------------------------

#Select columns which are needed
Preference_commute <- Preference[c(5, 89:96)]
...
#Select columns which are needed
Preference_business <- Preference[c(5, 98:105)]
...
#Select columns which are needed
Preference_education <- Preference[c(5, 107:114)]
...
#Select columns which are needed
Preference_grocery <- Preference[c(5, 116:123)]
...
#Select columns which are needed
Preference_shopping <- Preference[c(5, 125:132)]
...
#Select columns which are needed
Preference_visitation <- Preference[c(5, 134:141)]
...
#Select columns which are needed
Preference_daytrip <- Preference[c(5, 152:159)]
...
#Select columns which are needed
Preference_sports <- Preference[c(5, 161:168)]
...
#Select columns which are needed (Going out)
Preference_leisure <- Preference[c(5, 143:150)]
...
write.csv(Result_mandatory, "/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2014/Dissonance_mandatory_merged.csv")
write.csv(Result_maintenance, "/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2014/Dissonance_maintenance_merged.csv")
write.csv(Result_discretionary, "/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2014/Dissonance_discretionary_merged.csv")
