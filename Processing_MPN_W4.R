...
#Read data
Diary <- read_sav("/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2016/MPNWAVE4_DAGBOEKdata.sav")
...
write_sav(Diary_purposerec, "/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2016/MPNWAVE4_Diary_cleaned.sav")
...
write.csv(Mode_use, "/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2016/MPNWAVE4_ModeUse.csv")
...
#Read data
Preference <- read_sav("/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2016/MPNWAVE4_Pdata.sav")

#-----------------------------------------------Commute------------------------------------------------------------------------------------

#Select columns which are needed
Preference_commute <- Preference[c(5, 91:98)]
...
Preference_commute <- Preference_commute[c(1,10:16)]
...
Preference_commute <- Preference_commute %>%
  mutate(Commute = pmap(list(Preference_commute_3, Preference_commute_4, Preference_commute_5,
                             ...
                             Preference_commute_9), ~ na.omit(c(...))))  # Remove NAs

Preference_commute <- Preference_commute[c(1,9)]

#-----------------------------------------------Business------------------------------------------------------------------------------------

#Select columns which are needed
Preference_business <- Preference[c(5, 100:107)]
...
Preference_business <- Preference_business[c(1,10:16)]
...
Preference_business <- Preference_business %>%
  mutate(Business = pmap(list(Preference_business_3, Preference_business_4, Preference_business_5,
                             ...
                             Preference_business_9), ~ na.omit(c(...))))  # Remove NAs

Preference_business <- Preference_business[c(1,9)]


#-----------------------------------------------Education------------------------------------------------------------------------------------

#Select columns which are needed
Preference_education <- Preference[c(5, 109:116)]
...
Preference_education <- Preference_education[c(1,10:16)]
...
Preference_education <- Preference_education %>%
  mutate(Education = pmap(list(Preference_education_3, Preference_education_4, Preference_education_5,
                              ...
                              Preference_education_9), ~ na.omit(c(...))))  # Remove NAs

Preference_education <- Preference_education[c(1,9)]


#-----------------------------------------------Shopping------------------------------------------------------------------------------------

#Select columns which are needed
Preference_grocery <- Preference[c(5, 118:125)]
...
Preference_grocery <- Preference_grocery[c(1,10:16)]

#Select columns which are needed
Preference_shopping <- Preference[c(5, 127:134)]
...
Preference_shopping <- Preference_shopping[c(1,10:16)]
...
Preference_shopping <- Preference_shopping %>%
  mutate(Shopping = pmap(list(Preference_grocery_3, Preference_grocery_4, Preference_grocery_5,
                               ...
                               Preference_grocery_9, Preference_shopping_3, Preference_shopping_4, 
                               Preference_shopping_5, Preference_shopping_6, Preference_shopping_7, 
                               Preference_shopping_8, Preference_shopping_9), ~ na.omit(c(...))))  # Remove NAs

Preference_shopping <- Preference_shopping[c(1,16)]
...
#Select columns which are needed
Preference_visitation <- Preference[c(5, 136:143)]
...
Preference_visitation <- Preference_visitation[c(1,10:16)]
...
Preference_visitation <- Preference_visitation %>%
  mutate(Visitation = pmap(list(Preference_visitation_3, Preference_visitation_4, Preference_visitation_5,
                               ...
                               Preference_visitation_9), ~ na.omit(c(...))))  # Remove NAs

Preference_visitation <- Preference_visitation[c(1,9)]


#-----------------------------------------------Daytrip------------------------------------------------------------------------------------

#Select columns which are needed
Preference_daytrip <- Preference[c(5, 154:161)]
...
Preference_daytrip <- Preference_daytrip[c(1,10:16)]
...
Preference_daytrip <- Preference_daytrip %>%
  mutate(Daytrip = pmap(list(Preference_daytrip_3, Preference_daytrip_4, Preference_daytrip_5,
                                ...
                                Preference_daytrip_9), ~ na.omit(c(...))))  # Remove NAs

Preference_daytrip <- Preference_daytrip[c(1,9)]


#-----------------------------------------------Sports------------------------------------------------------------------------------------

#Select columns which are needed
Preference_sports <- Preference[c(5, 163:170)]
...
Preference_sports <- Preference_sports[c(1,10:16)]
...
Preference_sports <- Preference_sports %>%
  mutate(Sports = pmap(list(Preference_sports_3, Preference_sports_4, Preference_sports_5,
                             ...
                             Preference_sports_9), ~ na.omit(c(...))))  # Remove NAs

Preference_sports <- Preference_sports[c(1,9)]
...
#Select columns which are needed
Preference_leisure <- Preference[c(5, 145:152)]
...
Preference_leisure <- Preference_leisure[c(1,10:16)]
...
Preference_leisure <- Preference_leisure %>%
  mutate(Leisure = pmap(list(Preference_leisure_3, Preference_leisure_4, Preference_leisure_5,
                                ...
                                Preference_leisure_9), ~ na.omit(c(...))))  # Remove NAs

Preference_leisure <- Preference_leisure[c(1,9)]
...
Preference_maintenance <- Preference_shopping
Preference_maintenance$Maintenance <- Preference_maintenance$Shopping
...
write.csv(Result_mandatory, "/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2016/Dissonance_mandatory_merged.csv")
write.csv(Result_maintenance, "/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2016/Dissonance_maintenance_merged.csv")
write.csv(Result_discretionary, "/Users/xingxing/Library/CloudStorage/OneDrive-UniversiteitUtrecht/Phd/Paper 5 Multimodality by captive and cognitive dissonance/Data/2016/Dissonance_discretionary_merged.csv")
